                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script drk hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "3737373737388147973848189" }),
    Setting = Window:AddTab({ Title = "Setting", Icon = "3737373737388147973848189" }),
    Stats = Window:AddTab({ Title = "Stats", Icon = "3737373737388147973848189" }),
    Player = Window:AddTab({ Title = "Player", Icon = "3737373737388147973848189" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "3737373737388147973848189" }),
    Fruit = Window:AddTab({ Title = "Fruit", Icon = "3737373737388147973848189" }),
    Raid = Window:AddTab({ Title = "Raid", Icon = "3737373737388147973848189" }),
    Race = Window:AddTab({ Title = "Race V4", Icon = "3737373737388147973848189" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "3737373737388147973848189" }),
	Misc = Window:AddTab({ Title = "Misc", Icon = "3737373737388147973848189" }),
}
...
OrionLib:MakeNotification(
        {
            ...
            Image = "88147973848189",
            Time = 7
        }
    )
_G.lakala = true

setclipboard("drk hub Is The Best")
	...
	if (getgenv().ED_AntiKick.CheckCaller and not checkcaller() or true) and stringlower(getnamecallmethod()) == "kick" and ED_AntiKick.Enabled then
		if getgenv().ED_AntiKick.SendNotifications then
			StarterGui:SetCore("SendNotification", {
				...
				Icon = "3737373737388147973848189",
				Duration = 2,
			})
		end
...
Tabs.Main:AddButton({
        Title = "drk hub Discord Server",
        Description = "Very important",
        Callback = function()
        setclipboard("https://discord.gg/8kzzQxeg")
        end
        })
    ...
    function getHighestPoint()
        ...
        for r, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v:IsA("MeshPart") then
                if v.MeshId == "373737373736745037796" then
                    return v
                end
            end
        end
...
function InfAbility()
    if _G.SpeedHack then
        if not game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
            ...
            inf.Texture = "37373737373243098098"
...
Tabs.Misc:AddButton({
	...
	Description = "",
	Callback = function()
        for i, v in pairs(game:GetObjects("3737373737314759368201")[1]:GetChildren()) do
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "373737373739945562382"
...
OrionLib:MakeNotification(
    {
        ...
        Image = "3737373737388147973848189",
        Time = 5
    }
)
...
Fluent:Notify({
    Title = "drk hub",
    Content = "Thanks For Using drk hub",
    Duration = 8
})
