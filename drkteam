...
local Window = Fluent:CreateWindow({
	Title = "Drk Hub | owner drk dev vitor",
	SubTitle = "discord.gg/KcKTDCsU",
	TabWidth = 160,
...
_G['Drk  Hub Table'].SizeUi = (not _G['Drk  Hub Table'].isWindows and UDim2.fromOffset(600,300)) or UDim2.fromOffset(560,600)
if not _G['Drk  Hub Table'].isWindows then
...
do -- INFO FISH
	...
	FISHDATA = {
		...
		Pufferfish = {
			...
			Rarity = "Rare";
			Resilience = 65;
			Description = "Pufferfish are clumsy swimmers that can fill their elastic stomachs with huge amounts of water & air to blow themselves up to several times their Drk  size. They do this to evade and scare of predators. On top of their bloating abilities, they also are one of the most poisonous fish in the sea... Also they are the only bony fish which can close their eyes!";
...
do
	...
	InterfaceManager:SetFolder("Drk  Hub")
	InterfaceManager:BuildInterfaceSection(Tap.Settings)
	Window:SelectTab(1)
	SaveManager:LoadAutoloadConfig()
	Fluent:SetTheme("Drk  Theme")
